...
with DAG(
    ...
    schedule_interval=timedelta(hours=10),  # Run every 10 hours
    catchup=False,
) as dag:
    ...
    create_cluster = DataprocCreateClusterOperator(
        ...
        gcp_conn_id="gcptest",  # Added GCP connection
    )
    ...
    submit_job = DataprocSubmitJobOperator(
        ...
        job={
            ...
            'pyspark_job': {
                'main_python_file_uri': 'gs://dataengineering1-433721_spark_files/dataproc_script/transform_load_data_proc.py',
                'jar_file_uris': [
    ...
    # Task 4: Move files from the processed folder to the archive folder
    move_files = GCSToGCSOperator(
        task_id="move_files_to_archive",
        source_bucket="dataengineering1-433721_crypto_data_raw",
        source_object="processed_files_test/*",  # Match all files in the processed folder
        destination_bucket="dataengineering1-433721_crypto_data_archieve",
        destination_object="archive_files_test/",
